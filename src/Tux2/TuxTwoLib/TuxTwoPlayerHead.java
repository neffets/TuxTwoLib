...
public class TuxTwoPlayerHead {
	...
	public static ItemStack getHead(ItemStack is, UUID id , String texture) {
		net.minecraft.server.v1_12_R2.ItemStack stack = CraftItemStack.asNMSCopy(is);
	...
	public static NMSHeadData getHeadData(ItemStack is) {
		try{
			net.minecraft.server.v1_12_R2.ItemStack mcis = Attributes.getMinecraftItemStack(is);
			if(mcis == null) {
				return null;
			}
