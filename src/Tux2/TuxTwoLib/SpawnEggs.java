...
public class SpawnEggs {
	...
	public static ItemStack getSpawnEgg(EntityType type, int amount) {
		net.minecraft.server..ItemStack stack = CraftItemStack.asNMSCopy(new ItemStack(Material.MONSTER_EGG, amount));
		String name = "";
		switch (type) {
		case ARMOR_STAND:
			name = "ArmorStand";
	...
	public static EntityType getSpawnEggType(ItemStack is) {
		...
		net.minecraft.server..ItemStack mcis = Attributes.getMinecraftItemStack(is);
		if(mcis == null) {
			return null;
		}
